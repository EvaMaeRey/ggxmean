...
# "...mastery of advanced programming skills should not be allowed to crowd out data analysis skills or statistical thinking." 
...
# Now, infrastructure to *extend* ggplot2 ...
...
## The *flow* experience for more useful statistical geometries
...
`r chunk_reveal("lm_sequence", title = "### Relevant to OLS") `
...
`r chunk_reveal("geom_normal_dist", title = "### fitting distributions") `
