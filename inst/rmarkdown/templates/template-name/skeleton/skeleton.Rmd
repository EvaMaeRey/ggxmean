...
palmerpenguins::penguins %>% 
  ...
  ggxmean:::geom_x1sd() + 
  ggxmean:::geom_y1sd() +
  ggxmean:::geom_rsq1(fill = "blue") + 
  geom_xy1sd(fill = "green") +
  geom_xydiffsmean(alpha = 1,
                   fill = "plum3") + 
  geom_corrlabel() +
  ggxmean:::geom_lm() +
...
palmerpenguins::penguins %>% 
  ...
  geom_lmrun10(color = "green") +
  geom_lmrise10(color = "green") +
  geom_lmpredictx(alpha = .2) +
  geom_lmpredicty(alpha = .2) +
  geom_lminterceptcoords(hjust = 0) +
