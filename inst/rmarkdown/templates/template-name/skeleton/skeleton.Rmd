...
palmerpenguins::penguins %>% 
  ...
  ggxmean:::geom_xq2575(linetype = "dotted",
              size = .75) + #BREAK
  ggxmean:::geom_xmin(linetype = "dashed") + #BREAK
  ggxmean:::geom_xmax(color = "goldenrod") + #BREAK
  geom_boxplot(y = 0,
               width = 3,
               fill = "white",
               color = "black") #BREAK
...
```{r ols, include = F}
ggxmean:::geoms_chalk()  # let the default color be caulky
palmerpenguins::penguins %>% 
  ...
  ggxmean:::geom_lmfitted(color = "blue",    
                          size = 2) +
  ggxmean:::geom_lmresiduals(color = "tomato3") +
  ggxmean:::geom_ymean() +
  ggxmean:::geom_xmean() +
  ggxmean:::geom_xymean(size = 3, color = "lightpink4") +
  ...
  annotate(geom = "point", 
           ...
           size = 5,
           shape = "diamond") +
  ggxmean:::geom_lmrun(color = "violetred4") +
  ggxmean:::geom_lmrise(color = "violetred4") +
  ggxmean:::geom_lmrun10(color = "chartreuse3") +
  ggxmean:::geom_lmrise10(color = "chartreuse3") +
  ggxmean:::geom_lmpredictx(alpha = .2) +
  ggxmean:::geom_lmpredicty(alpha = .2) +
  ggxmean:::geom_lmintercept() +
  ggxmean:::geom_lminterceptcoords(hjust = 0)
```
