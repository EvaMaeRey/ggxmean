...
<a href="https://evamaerey.github.io/ggxmean/template.html" target="_blank">Open flipbook in a new tab</a>
...
xaringanBuilder::build_all("docs/template.Rmd", include = c('html', 'gif'))
xaringanPrinter::slides_gif("docs/template.html")
```
